...
class Testmodels(unittest.TestCase):
    ...
    def test_underweight_malnutrition(self):
        ...
        self.assertNotEqual(bmi_cal(16)[0], 'Normal weight')
        self.assertNotEqual(bmi_cal(16)[1], 'Low risk')
    ...
    def test_normalweight_low(self):
        ...
        self.assertNotEqual(bmi_cal(23.2)[0], 'Overweight')
        self.assertNotEqual(bmi_cal(23.2)[1], 'Enhanced risk')
    ...
    def test_overweight_enhanced(self):
        ...
        self.assertNotEqual(bmi_cal(28)[0], 'Moderately obese')
        self.assertNotEqual(bmi_cal(28)[1], 'Medium risk')
    ...
    def test_moderatelyobese_medium(self):
        ...
        self.assertNotEqual(bmi_cal(32)[0], 'Overweight')
        self.assertNotEqual(bmi_cal(32)[1], 'Enhanced risk')
    ...
    def test_severelyobese_high(self):
        ...
        self.assertNotEqual(bmi_cal(39)[0], 'Overweight')
        self.assertNotEqual(bmi_cal(39)[1], 'Enhanced risk')
    ...
    def test_veryseverelyobese_veryhigh(self):
        ...
        self.assertNotEqual(bmi_cal(56)[0], 'Moderately obese')
        self.assertNotEqual(bmi_cal(56)[1], 'Medium risk')
